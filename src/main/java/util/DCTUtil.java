...
/**
 * Different ways to calculate DCT.
 * <p/>
 * Created by yanliw on 17-4-19.
 */
public class DCTUtil {

    private static final double SQRT_TWO = Math.sqrt(2);
    private static final int c1 = 1004, s1 = 200, c3 = 851, s3 = 569, r2c6 = 554, r2s6 = 1337, r2 = 181;
    ...
    private static double B1 = 1.3870398453221474618216; // cos(pi*1/16)sqrt(2)
    private static double B2 = 1.3065629648763765278566; // cos(pi*2/16)sqrt(2)
    private static double B3 = 1.1758756024193587169745; // cos(pi*3/16)sqrt(2)
    private static double B4 = 1.0000000000000000000000; // cos(pi*4/16)sqrt(2)
    private static double B5 = 0.7856949583871021812779; // cos(pi*5/16)sqrt(2)
    private static double B6 = 0.5411961001461969843997; // cos(pi*6/16)sqrt(2)
    private static double B7 = 0.2758993792829430123360; // cos(pi*7/16)sqrt(2)
   
    private static double A4 = 0.70710678118654752438; // cos(pi*4/16)
    private static double A2 = 0.92387953251128675613; // cos(pi*2/16)
    
    private static final double prescale[] = {
    ...
    public static int[][] do2DDCTWithAAN(int[][] originalBlock) {
        ...
        for (int i = 0; i < dctBlkLen; ++i) {
            int[] tmp = AAN1DDCT(originalBlock[i]);
     ...
     * @see <a href="https://unix4lyfe.org/dct">https://unix4lyfe.org/dct</a>
     */
    public static int[] AAN1DDCT(int[] inBlock) {
     ...
     */
    public int[][] native2DDCT(int[][] originalBlock) {
        int[][] dctVals = new int[dctBlkLen][dctBlkLen];
    ...
    public static int[][] doiDCTN3(int quantization, int[][] rowColBlock) {
    ...
    public static int[] aanIDCT (int quantization, int[] dctVals) {
